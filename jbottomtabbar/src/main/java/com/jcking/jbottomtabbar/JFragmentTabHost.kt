...
class CustomFragmentTabHost(context: Context, attrs: AttributeSet? = null)
    ...
    private fun doTabChanged(tabId: String, ftn: FragmentTransaction?): FragmentTransaction? {
        var ft = ftn

        var tempTab: TabInfo? = null
        mTabs.forEach {
            if (it.tag == tabId) {
                tempTab = it
            }
    ...
    internal class SavedState : View.BaseSavedState {
        ...
        override fun toString() = "FragmentTabHost.SavedState{" +
